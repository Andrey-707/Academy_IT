...
# # Разбить текст на буквы, очистить от знаков препинания (выводит каждую букву и цифры отдельно, так же знак "_" подчеркивания
# # остается).
# s_reg = r"\w" # \w - ищем ВСЕ буквы (отдельно)
# c_reg = re.compile(s_reg)
# print(*c_reg.findall(s))

# # Разбить текст на слова, очистить от знаков препинания (выводит каждое слово и цифры отдельно, так же знак "_" подчеркивания
# # остается).
...
# # Вывести текст, склеив его по две буквы. Если для следующей буквы нет пары, она удалится (знаки препинания УДАЛЯЮТСЯ).
# s_reg = r"\w\w"
# c_reg = re.compile(s_reg)
# print(*c_reg.findall(s))
...
# # Вывести ВСЕ цифры (разбить длинные числа на отдельные цифры).
# print(re.findall(r"\d", s))

# # Вывести ВСЕ числа (длинные числа НЕ разбиваются на отдельные цифры).
# print(re.findall(r"\d+", s))

# # Вывести ВСЁ, что начинается с цифы, заканчивается текстом (даже если это находится в СЕРЕДИНЕ слова.)
# print(re.findall(r"\d\w+", s))

# # Вывести ВСЕ слова, которые начинаются с цифы, заканчивается текстом (если находится в СЕРЕДИНЕ слова, то не выводится)
# print(re.findall(r"\b\d\w+", s))

# # Вывести ВСЕ слова, в которых есть опечатка в виде числа (число внутри слова)
# print(re.findall(r"[а-я]{1,2}\d\w+", s))

# # Вывести ВСЕ слова, которые начинаются с буквы "н" или "м" или "т"
# print(re.findall(r"\b[нмт]\w+", s))

# # Вывести ВСЕ слова, которые НЕ начинаются с буквы "т" или "п" или "к" или "г" или с символа "пробел"
# print(re.findall(r"\b[^тпкг ]\w+", s))

# # Вывести ВСЕ слова, которые начинаются с "тр"
# print(re.findall(r"тр\w+", s))

# # Вывести ВСЕ словосочетания, которые начинаются с трех букв ВНУТРИ которых встречается "тр" затем может быть 7 букв
...
# # Вывести ВСЕ слова, которые находятся в кавычках «слово»
# print(re.findall(r"«\w+»", s))

# # Вывести ВСЕ слова, образца <<кавычки_текст_пробел_текст_кавычки>>
# print(re.findall(r"«\w+\s\w+»", s))

# # Вывести ВСЕ слова И словосочетания, которые находятся внутри кавычек.
# print(re.findall(r"«.+»", s))

# # Вывести одно ИЛИ два ИЛИ три слова внутри кавычек.
# print(re.findall(r'«\w+»|«\w+\s\w+»|«\w+\s\w+\s\w+»', s)) # символ "|" - логическое или
...
# # Удалить из текста знаки препинания
# print(re.sub(r"[!?,.:\n]", "", tweet))
