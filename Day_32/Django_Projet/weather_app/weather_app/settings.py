...
s_path.append(str(PROJECT_ROOT / 'apps')) # s_spath.insert(0, PROJECT_ROOT.joinpath('apps'))
...
SECRET_KEY = 'django-insecure-kh*1-n%!it+u5cb*o5=e80)%(5p@d$f)mezwj%d9ah765lrkg*'
