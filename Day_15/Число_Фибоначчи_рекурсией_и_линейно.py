...
print("TIME:", time() - start1)                                             # TIME: 0.0
...
start2 = time()
print("RESULT:", fib(45))                                                   # RESULT: 1134903170
print("TIME:", time() - start2)                                             # TIME: 0.0
...
start3 = time()
print("RESULT:", fib(45))                                                    # RESULT: 1134903170
print("TIME:", time() - start3)                                              # TIME: 0.0
...
start6 = time()
print("RESULT:", fib(45))                                                    # RESULT: 1134903170
print("TIME:", time() - start6)                                              # TIME: 387.99680256843567

# Такая рекурентрая асимптотика вычисления числа Фибоначчи ОЧЕНЬ медленная, она равна O(Fibn)
# Время выполнения поиска числа Фибоначчи при n = 45 fib(45) равна ~ 387 СЕК
...
start7 = time()
print("RESULT:", fib(45))                                                    # RESULT: 1134903170
print("TIME:", time() - start7)                                              # TIME: 0.0
