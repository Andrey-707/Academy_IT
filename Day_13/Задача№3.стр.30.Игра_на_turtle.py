...
# Окончательный вариант кода игры в файле:
# Turtle_game_The_bun's_adventures_V1.0.main.py

# Задача№3.стр.30. Игра на turtle

'''
Можно играть мышкой, выбирать люки снизу вверх, в конце кликнуть мышкой на солнышко чтобы победить.
Можно управлять колобком стрелками, кнопкой '3' открывать люки, на поверхности нажать кнопку '3' чтобы победить.
'''
import turtle
